...
public class GlobalExceptionHandler {
    ...
    //οταν ψαχνουν κατι που δεν υπαρχει
    ...
    //οταν προσπαθει ενας χρειστης που δεν εχει αρμοδιοτητα να κανει κατι
    ...
    //οταν κανει ενα request ενας χρειστης λαθος ή με εληπει στοιχια
