...
public ResponseEntity<Void> addStaffToFestival(
    ...
    //Για την διαγραφη ενος φεστιβαλ
    @DeleteMapping("/{id}")
    ...
    //για να μπορεσουν οι καλητεχνες να διλοσουν performance
...
//για να μπορεσουν να κανουν review το φεστιβαλ
...
//βαση του id του φεστιβαλ να δουν οτι γινετε ή οχι
